...
export default defineConfig({
  ...
  optimizeDeps: {
    exclude: ['lightning/modal', 'lightning/primitiveOverlay', 'lightning/overlayUtils', 'lightning/modalBase', 'lightning/utilsPrivate', 'lightning/toast', 'lightning/toastContainer', 'lightning/showToastEvent', 'lightning/shadowBaseClassPrivate', 'lightning/utils', 'lightning/resizeObserver', 'lightning/f6Controller', 'lightning/utilsInternal', 'lightning/features'],
  },
  resolve: {
    alias: {
