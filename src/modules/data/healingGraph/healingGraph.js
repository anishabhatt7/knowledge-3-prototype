...
export const seedGraphNodes = [
    { id: 'dom-billing', label: 'Billing', type: 'domain', capability: 'shared', size: 20 },
    { id: 'dom-product', label: 'Product', type: 'domain', capability: 'shared', size: 20 },
    { id: 'dom-compliance', label: 'Compliance', type: 'domain', capability: 'shared', size: 20 },
    { id: 'dom-engineering', label: 'Engineering', type: 'domain', capability: 'shared', size: 20 },
    { id: 'dom-onboarding', label: 'Onboarding', type: 'domain', capability: 'shared', size: 20 },
    { id: 'dom-competitive', label: 'Competitive Intelligence', type: 'domain', capability: 'shared', size: 20 },
    { id: 'agent-billing', label: 'Billing Agent', type: 'agent', capability: 'C1', size: 15 },
    { id: 'agent-product', label: 'Product Agent', type: 'agent', capability: 'C1', size: 15 },
    { id: 'agent-compliance', label: 'Compliance Agent', type: 'agent', capability: 'C1', size: 15 },
    { id: 'agent-engineering', label: 'Engineering Agent', type: 'agent', capability: 'C1', size: 15 },
    { id: 'agent-onboarding', label: 'Onboarding Agent', type: 'agent', capability: 'C1', size: 15 },
    { id: 'agent-competitive', label: 'Competitive Intel Agent', type: 'agent', capability: 'C1', size: 15 },
...
export const seedHealthDomains = [
    { domain: 'Billing', healthScore: 92, freshnessScore: 91, contradictionCount: 3, orphanCount: 2, totalEntities: 156, freshnessSLA: '7 days', slaBreaches: 1 },
    { domain: 'Product', healthScore: 87, freshnessScore: 83, contradictionCount: 5, orphanCount: 4, totalEntities: 203, freshnessSLA: '14 days', slaBreaches: 3 },
    { domain: 'Compliance', healthScore: 78, freshnessScore: 69, contradictionCount: 7, orphanCount: 6, totalEntities: 98, freshnessSLA: '30 days', slaBreaches: 5 },
    { domain: 'Engineering', healthScore: 85, freshnessScore: 85, contradictionCount: 4, orphanCount: 8, totalEntities: 312, freshnessSLA: '7 days', slaBreaches: 4 },
    { domain: 'Onboarding', healthScore: 71, freshnessScore: 62, contradictionCount: 6, orphanCount: 11, totalEntities: 87, freshnessSLA: '14 days', slaBreaches: 7 },
    { domain: 'Competitive Intelligence', healthScore: 65, freshnessScore: 57, contradictionCount: 9, orphanCount: 14, totalEntities: 134, freshnessSLA: '7 days', slaBreaches: 12 },
];

export const seedContradictions = [
    { id: 'contra-001', entityA: { id: 'ent-api-rate-limit', title: 'API Rate Limiting Configuration', claim: 'API rate limit is 1000 requests per minute for all tiers.' }, entityB: { id: 'ent-partner-integration', title: 'Partner Integration Guide', claim: 'API rate limit is 500 requests per minute for standard tier partners.' }, domain: 'Engineering', severity: 'critical', detectedAt: h(6), suggestedResolutions: [
    ...
    { id: 'contra-002', entityA: { id: 'ent-refund-policy', title: 'Customer Refund Policy', claim: 'Refunds are processed within 5-7 business days.' }, entityB: { id: 'ent-billing-faq', title: 'Billing FAQ', claim: 'Refunds are processed within 3-5 business days.' }, domain: 'Billing', severity: 'high', detectedAt: h(12), suggestedResolutions: [
    ...
    { id: 'contra-003', entityA: { id: 'ent-onboarding-flow', title: 'Customer Onboarding Flow', claim: 'New accounts receive a 14-day free trial.' }, entityB: { id: 'ent-pricing-model', title: 'Pricing Model Documentation', claim: 'New accounts receive a 30-day free trial on all plans.' }, domain: 'Onboarding', severity: 'high', detectedAt: d(1), suggestedResolutions: [
    ...
    { id: 'contra-005', entityA: { id: 'ent-ci-battlecards', title: 'Acme Analytics Battlecard', claim: 'Acme Analytics does not support SSO integration.' }, entityB: { id: 'ent-pricing-matrix', title: 'Competitor Pricing Matrix Q1 2026', claim: 'Acme Analytics launched SSO support in their Enterprise tier in February 2026.' }, domain: 'Competitive Intelligence', severity: 'high', detectedAt: d(2), suggestedResolutions: [
